...
class Account extends CI_Controller {
    ...
    function createNew() {
	        ...
	        $secu = new Securimage();
            if ($secu->check($_POST['captcha_code']) == false) {
                $data['errmsg']='Capcha incorrect.';
	    	...
	    	$this->form_validation->set_rules('password','Password','required|matches[passconf]|alpha_dash|min_length[6]');
    ...
    function updatePassword() {
	    	...
	    	$this->form_validation->set_rules('newPassword', 'New Password', 'required|alpha_dash|min_length[6]');
	    	...
	    	else
	    	{
	    		...
	    		if ($user->comparePassword($oldPassword)) {
	    			...
	    			redirect('arcade/index', 'refresh'); //Then we redirect to the index 
	    			page again
	    		}
	    		else {
    ...
    function recoverPassword() {
	    	...
	    	{ 
	    		...
	    		if (isset($user)) {
	    			...
	    			$config['smtp_user']    = 'g3naiver@gmail.com';
	    			$config['smtp_pass']    = '640318wy';
	    			...
	    			$this->email->from('g3naiver@gmail.com', 'Login App');
